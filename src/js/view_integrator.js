class ViewIntegrator {
    ...
    generateViewRawData(oldContext, newContext){
        ...
        return {
          ...
          "js-buyer-one-total-capacity": newContext.robots["buyer_one"].production * newContext.robots["buyer_one"].quantity * newContext.ticksPerSecond, //productividad del robot * cantidad de robots
          ...
          "js-buyer-two-total-capacity": newContext.robots["buyer_two"].production * newContext.robots["buyer_two"].quantity * newContext.ticksPerSecond,
          ...
          "js-buyer-three-total-capacity": newContext.robots["buyer_three"].production * newContext.robots["buyer_three"].quantity * newContext.ticksPerSecond,
          ...
          "js-repairer-one-total-capacity": newContext.robots["repairer_one"].production * newContext.robots["repairer_one"].quantity * newContext.ticksPerSecond,
          ...
          "js-repairer-two-total-capacity": newContext.robots["repairer_two"].production * newContext.robots["repairer_two"].quantity * newContext.ticksPerSecond,
          ...
          "js-repairer-three-upg-price": newContext.upgrades["upgrade_repairer_three"].price,
          "js-repairer-three-upg-bought": newContext.upgrades["upgrade_repairer_three"].isActive,
          "js-repairer-three-upg-multiplier": newContext.upgrades["upgrade_repairer_three"].productionMultiplier,
          "js-repairer-three-total-capacity": newContext.robots["repairer_three"].production * newContext.robots["repairer_three"].quantity * newContext.ticksPerSecond,
          ...
          "js-seller-one-total-capacity": newContext.robots["seller_one"].production * newContext.robots["seller_one"].quantity * newContext.ticksPerSecond,
          ...
          "js-seller-two-total-capacity": newContext.robots["seller_two"].production * newContext.robots["seller_two"].quantity * newContext.ticksPerSecond,
          ...
          "js-seller-three-total-capacity": newContext.robots["seller_three"].production * newContext.robots["seller_three"].quantity * newContext.ticksPerSecond,
